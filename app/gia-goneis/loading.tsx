...
export default function GiaGoneisLoading() {
  return (
    <PageWrapper>
      {/* Hero skeleton */}
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {Array.from({ length: 6 }).map((_, idx) => (
              <div
                key={idx}
                className="bg-background-white rounded-[20px] overflow-hidden border-2 border-white h-[400px] animate-pulse"
              >
                <div className="w-full h-64 bg-background-light" />
